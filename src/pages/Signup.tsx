import { Text, Box, Input, NativeBaseProvider, Button, HStack, FormControl, Modal} from "native-base";
        ...
        <NativeBaseProvider theme={theme}>
            <Box flex={1} alignSelf='center' alignItems={'center'} justifyContent='center' paddingTop= '100px'>
                ...
                <Modal isOpen={showModal} defaultIsOpen onClose={closeModal} justifyContent='center' size='lg'>
                    <Modal.Content maxWidth={'300px'}>
                        ...
                        <Modal.Body>
                            ...
                            If you are a Tower employee you will need to verify your email and then contact your manager to gain the appropriate
                            permissions to access the website.
                        </Modal.Body>
                ...
                <FormControl alignItems={'center'} isInvalid={passwordError}>
                    ...
                    <Input isRequired onChangeText={(e) => setPasswordCheck(e)} marginBottom='5px' type="password" placeholder="password confirmation" width={'60%'}/>
                    {passwordError && <FormControl.ErrorMessage>Passwords do not match</FormControl.ErrorMessage>}
                    {signUpError && <FormControl.ErrorMessage>Signup error</FormControl.ErrorMessage>}
                    {sendEmailError && <FormControl.ErrorMessage>Could not send email verification.</FormControl.ErrorMessage> }
                    <HStack space={'1rem'}>
